...
- Here finish the xample with clustering
...
This uses the cluster mode that we learn in previous lessons. PM@ uses the cluster module internally but it provide many capabilities to help you manage that cluster
...
<Worker threads> uses the V8 in asolate instead of multiple processes like <clustering>
