...
1. json middleaware is need to add new item (POST)
...
Controller => is teh function that react to the incoming request and set the respond accordingly.
...
- Exprexx conceptual explanation
- Route parameters
- Postman
